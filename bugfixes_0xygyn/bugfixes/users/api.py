...
class UserWhoAmIAPI(generics.RetrieveAPIView):
    ...
    queryset = User.objects.all()
    permission_classes = (IsAuthenticated, )
    # Vulnerable: exposed full UserSerializer including sensitive fields
    # serializer_class = UserSerializer
    # Fix: limit fields returned to prevent privilege escalation
    serializer_class = UserCompactSerializer  # fixes #59
